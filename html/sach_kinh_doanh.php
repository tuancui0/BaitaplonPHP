        ...
        <div id="main_heder">
            ...
            <div class="icon">
                <div id="donhang">
                    ...
                    <div><a href="../html/trangthai_donhang.php"><p>Tra cứu đơn hàng</p></a></div>                </div>
                <div id="giohang"> 
                    <div id="icon2">
    ...
    <div class="main_main">
        <div class="cotainer_menu">
            <ul><h4>DANH MỤC SẢN PHẨM</h4>
                ...
                <li><a href="../html/sach_mam_non.php"><h5>SÁCH MẦM NON</h5></a></li>
                <li><a href="../html/sach_thieu_nhi.php"><h5>SÁCH THIẾU NHI</h5></a></li>
                <li><a href="../html/sach_ky_nang.php"><h5>SÁCH KĨ NĂNG</h5></a></li>
                <li><a href="../html/sach_kinh_doanh.php"><h5 id="this">SÁCH KINH DOANH</h5></a></li>
            </ul>
        </div>
        <div class="container">
            <div>
                <div class="container_title">
                    <h4>SÁCH KINH DOANH</h4>
                </div>

                <!-- Hiển thị danh sách sách từ cơ sở dữ liệu -->
                <div class="container_row">
                    <?php include('../php/sachkinhdoanh.php');; ?> <!-- Nhúng file PHP để lấy dữ liệu -->
                </div>
            </div>
        </div>
    </div>
